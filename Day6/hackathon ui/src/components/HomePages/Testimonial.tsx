    ...
    <section className="bg-gradient-to-br from-black to-gray-900 text-white py-16 md:py-24 relative overflow-hidden">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="text-center mb-16">
          <h2 className="text-amber-500 text-4xl md:text-5xl mb-4">
            Testimonials
          </h2>
              ...
              <div className="flex justify-center mb-6">
                {[...Array(5)].map((_, i) => (
                  <motion.svg
                    ...
                    className={`w-6 h-6 mx-1 ${i < testimonials[currentTestimonial].rating ? 'text-amber-500' : 'text-gray-300'}`}
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
        ...
        <div className="flex justify-center items-center gap-4 mt-8">
          {testimonials.map((_, index) => (
            <Button
              ...
              className={`w-3 h-3 p-0 rounded-full transition-all duration-300 ${index === currentTestimonial ? 'bg-amber-500 scale-125' : 'bg-gray-400 hover:bg-amber-400'}`}
