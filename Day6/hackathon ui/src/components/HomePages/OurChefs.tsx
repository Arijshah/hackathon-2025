    ...
    <div className="bg-black min-h-screen w-full">
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-tight text-[#FF9F0D] font-bold text-center mb-4 sm:mb-6">
            Chefs
          </h1>
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-16 py-16">
            ...
            >
              <div className="relative aspect-w-4 aspect-h-3">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gray-900/90 p-4 text-white transform transition-transform duration-300 group-hover:translate-y-0">
                  <h3 className="text-lg font-bold text-[#FF9F0D]">
                    {chef.name}
                  </h3>
        ...
        <div className="flex justify-center mt-12">
          <Link href="./chefs">
            <Button 
              className="px-8 py-3 rounded-full border-2 border-[#FF9F0D] text-white text-lg transition-all duration-300 hover:bg-[#FF9F0D] hover:text-black focus:outline-none focus:ring-2 focus:ring-[#FF9F0D] focus:ring-opacity-50"
            >
              See More
            </Button>
          </Link>
