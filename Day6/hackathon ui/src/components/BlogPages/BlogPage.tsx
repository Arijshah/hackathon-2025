...
const HeroPage = () => {
      ...
      <section className="container mx-auto px-4 py-8 md:py-12">
        <div className="flex flex-col lg:flex-row gap-6 md:gap-8">
          ...
          <div className="flex-1 space-y-6 md:space-y-8">
            {[1, 2, 3, 4].map((i) => (
              <BlogCard key={i} imageSrc={`/Blog/recentpost${i}.jpeg`} id={""} />
            ))}
          </div>
  ...
  <div className="flex justify-center gap-4">
    {[ 
      { Icon: FaFacebook, bg: "bg-[#C4C4C4]", href: "https://facebook.com" },
      { Icon: FaYoutube, bg: "bg-[#C4C4C4]", href: "https://youtube.com" },
      { Icon: FaInstagram, bg: "bg-[#FF9F0D]", href: "https://instagram.com" },
      { Icon: SiPixelfed, bg: "bg-[#C4C4C4]", href: "https://pixelfed.org" },
      { Icon: FaTwitter, bg: "bg-[#C4C4C4]", href: "https://twitter.com" }
    ].map(({ Icon, bg, href }, index) => (
      <Link key={index} href={href}>
        <a className={`${bg} p-3 rounded-full cursor-pointer hover:opacity-80 transition-opacity`}>
